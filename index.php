          ...
          <div class="col-md-3">
            ...
            <div class="select-wrap">
              ...
              <select name="types" id="list-types" class="form-control d-block rounded-0">
                ...
                <option value="<?php echo str_replace('-',' ',$category->name );?>"><?php echo $category->name;?></option>
                <?php endforeach; ?>
              </select>
            </div>
          </div>
    ...
    <div class="row mb-5">
      ...
      <div class="col-md-6 col-lg-4 mb-4">
        <div class="property-entry h-100">
          <a href="property-details.php?id=<?php echo $property->id;?>" class="property-thumbnail">
            <div class="offer-type-wrap">
              <span class="offer-type bg-<?php if($property->type=="rent"){echo "success";}else{echo "danger";} ?>"><?php echo $property->type; ?></span>
            </div>
            <img src="images/<?php echo $property->image; ?>" alt="Image" class="img-fluid">
          </a>
          <div class="p-4 property-body">
            <!-- <a href="#" class="property-favorite"><span class="icon-heart-o"></span></a> -->
            <h2 class="property-title"><a href="property-details.php?id=<?php echo $property->id; ?>"><?php echo $property->name; ?></a></h2>
